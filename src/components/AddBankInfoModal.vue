      ...
      <div class="modal-content">
        <div class="modal-header">
          <div class="addinfo__title">
            <p class="addinfo__main">Добавление счета</p>
            <p class="addinfo__sec">
              Заполните данные о своем банковском счете
            </p>
          </div>
          <button class="modal__close" data-bs-dismiss="modal"> <img src="@/assets/img/closemodal.svg" style="width:24px;" alt="">  </button>
        </div>
              ...
              <div class="types__flex">
                ...
                <div class="money__types">
                  <div
                    :class="[
                      'money__type',
                      { type__active: moneytype == 'tenge' },
                    ]"
                    @click="moneytype = 'tenge'"
                  >
                    <img
                      src="@/assets/img/tenge.svg"
                      style="width: 0.781vw"
                      alt=""
                    />
                  </div>
                  <div
                    :class="[
                      'money__type',
                      { type__active: moneytype == 'dollar' },
                    ]"
                    @click="moneytype = 'dollar'"
                  >
                    <img
                  ...
                  <div
                    :class="[
                      'money__type',
                      { type__active: moneytype == 'euro' },
                    ]"
                    @click="moneytype = 'euro'"
                  >
                    <img
