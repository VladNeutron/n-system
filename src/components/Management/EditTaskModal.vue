    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="d-flex flex-column">
            ...
            <h3 class="modal-sub-title" id="exampleModalLabel">В колонке "Первичный контакт"</h3>
        </div>
        <img
      ...
      <div class="modal-body">
          <div class="row">
              <div class="col-6">
                    <p class="modalTitles">Описание задачи</p>
              ...
              <div class="col-6">
                ...
                <select class="form-select" id="dealCLient">
                    ...
                    <option selected>ИП "Ромашка"</option>
                </select>
                </div>
              </div>
              <div class="col-6">
...
export default {
    ...
    mounted(){
        let myModal = document.getElementById('EditTaskModal')
        ...
        myModal.addEventListener('shown.bs.modal', function () {
            ...
            pos.x = document.querySelector('#EditTaskModal').querySelector(".labels__container").getBoundingClientRect().x; 
            pos.y = document.querySelector('#EditTaskModal').querySelector(".labels__container").getBoundingClientRect().y; 
