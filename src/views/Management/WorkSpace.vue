  ...
  data() {
    return {
      ...
      activity: [
        ...
        {
          name: "Договор подписать",
          count: 12,
        },
        {
          name: "Съездить на встречу",
          count: 11,
        },
        {
          name: "Ревизия",
...
<style scoped>
.activity__content::-webkit-scrollbar {
  background: #e2e8f0;
  border-radius: 0.78vw;
  width: 0.7vw;
}

.activity__content::-webkit-scrollbar-thumb {
  border-radius: 0.78vw;
  background-color: #313860;
}

.activity__content::-webkit-scrollbar-track {
...
.block:hover {
  box-shadow: 0px 3.5px 5.5px rgba(112, 146, 224, 1);
  transition: 0.2s;
}
...
.funnel__content::-webkit-scrollbar-track {
  -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.2);
  border-radius: 0.78vw;
  background-color: #e2e8f0;
}
...
.deals__table::-webkit-scrollbar {
  background: #e2e8f0;
  border-radius: 0.78vw;
  width: 0.32vw;
}

.deals__table::-webkit-scrollbar-thumb {
  border-radius: 0.78vw;
  background-color: #313860;
}

.deals__table::-webkit-scrollbar-track {
  -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.2);
  border-radius: 0.78vw;
  background-color: #e2e8f0;
}
