                ...
                <table class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                    <tr v-for="item in paginationList" :key="item">
                      ...
                      <td class="">
                        <div class="dropdown">
                          <img src="@/assets/img/dots.svg" style="width: 1.563vw; cursor: pointer" alt="" class="" />
    ...
    filteredItems() {
      return this.items.filter(
        (item) =>
          ...
          (this.filterStatus === "" ? true : item.isReady === this.filterStatus)
          &&
...
.paginate_button.current {
  background-image: linear-gradient(83.56deg,
      #7092e0 10.01%,
