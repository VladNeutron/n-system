        ...
        <div class="container-fluid">
            <div class="documentHeader">
                ...
                <div class="documentHeader__btns">
                    <button class="btn edit__bnt"><img src="@/assets/img/edo/EditEdoBtn.svg" alt="" onclick="window.location.href = '/accounting/documents/edit-account'"> Изменить</button>
                    <comment-button style="margin-right: 24px"></comment-button>
                    <action-button style="margin-right: 24px"></action-button>
                    <button class="btn save__btn">Подписать</button>
                </div>  
            </div>   
                ...
                <div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <td>
                                <div v-if="sign.status=='Подписан'" class="btn status__btn bg-gradient-success">{{sign.status}}</div>
                ...
                <div class="col-7">
                    <div id="my_pdf_viewer">
                        ...
                        <div id="canvas_container">
                            <vue-pdf-embed ref="pdfRef" @rendered="handleDocumentRender" :source="'../schet.pdf'" :page="pdfPage"/>
                        </div>
                    </div>
                </div>
                <div class="col-5">
                    <div class="participants card">
                        <div class="participants__header">
                            ...
                            <button class="btn">Пригласить участника</button>
                        </div>
                        <div>
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-left: 0; padding-right: 27px">
                                            ...
                                            <div class="dropdown-content">
                                                <a href="/sales/order" style="white-space: pre-wrap;">Отправить приглашение повторно</a>
                                                <hr />
                                                <a style="cursor: pointer" data-bs-toggle="modal" data-bs-target="#DeleteInv">Отозвать приглашение</a>
                                            </div>
                                            </div>
                                        </td>
                                    </tr>
