<template>
      ...
      <div class="order__header-content">
        <div class="order__header-main">
          <div class="order__header-text">
            <p class="order__header__main">Создание акта</p>
          ...
          <div class="drop__buttons">
            ...
            <button class="btn save__btn"
              onclick="window.location.href = '/accounting/documents/acts-list'">Сохранить</button>
          </div>
        </div>
          ...
          <div class="order__body__content">
            <div class="order__first__row">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label order__label">№ Акта</label>
            ...
            <div class="order__first__row">
              <div class="form-group">
                ...
                <div class="select">
                  <select class="form-select" id="exampleFormControlSelect1" style="width: 16.979vw">
        ...
        <div class="not__added" v-if="isAdded">
          <div>
            ...
            <p class="not__added__sec">
              Для того чтобы создать акт, необходимо<br />
  ...
  <commentary :pageTitle="'Создание акта'"></commentary>
