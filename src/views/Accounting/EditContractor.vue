        ...
        <div class="container-fluid">
            <div class="page__name d-flex align-items-center justify-content-between">
                <div class="page__name-title text-start" v-if="activeBtn == 1">
                    ...
                    <p class="mb-0">Добавьте информацию и нажмите “Сохранить”</p>
                </div>
                <div class="page__name-title text-start" v-if="activeBtn == 2">
                    <h3>Банковские счета контрагента</h3>
                    <p class="mb-0">Добавьте информацию и нажмите “Сохранить”</p>
                </div>
                <div class="header__buttons">
                    <button class="btn filter__button mb-0" :class="{ active: activeBtn == 1 }" @click="activeBtn = 1">
                        <img src="@/assets/img/note.svg" style="width: 1.25vw; margin-right: 0.417vw" alt="" />
                        Информация о контрагенте
                    </button>
                    <button class="btn filter__button mb-0" :class="{ active: activeBtn == 2 }" @click="activeBtn = 2">
                        <img src="@/assets/img/monetization_on.svg" style="width: 1.25vw; margin-right: 0.417vw"
                            alt="" />
                        Банковские счета
                    </button>
                </div>
...
<script>
import ContractorInfoComp from "@/components/ContractorInfoComp.vue";
import ContractorBankInfo from "@/components/ContractorBankInfo.vue";
export default {
    components: { ContractorInfoComp, ContractorBankInfo },
    data() {
        return {
            activeBtn: 1,
        };
