<template>
  ...
  <main class="main-content border-radius-lg">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <lists-header>
            <template v-slot:title> Счет-фактуры </template>
          ...
          <div class="card py-4 main__card">
            <div class="d-flex justify-content-between align-items-center mx-4 mb-4">
              <button class="btn bg-gradient-dark mb-0" style="
                  ...
                  display: flex;
                  align-items: center;
                " onclick="window.location.href = '/accounting/documents/create-invoice'">
                    ...
                    <tr v-for="(order, i) of paginationList" :key="order.id">
                      ...
                      <td class="dropdown" style="border-left: 0; width: 100%">
                        ...
                        <div class="dropdown-content">
                          <a href="/accounting/documents/edit-invoice">Редактировать</a>
                          <hr />
  ...
  <delete-modal :title="'счет-фактуры'" :text="`документ  &quot;счет-фактура №12132145&quot;`"></delete-modal>
</template>
