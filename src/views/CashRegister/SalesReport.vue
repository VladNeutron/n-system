        ...
        <div class="card pt-4 pb-4 card__padding">
            <div class="page__name d-flex align-items-center justify-content-between">
                <div class="page__name-title text-start">
                    ...
                    <p class="mb-0">Здесь можно увидеть все данные по продажам по кассе</p>
                </div>
                <div class="buttons">
                    ...
                    <div class="analytic__sales">
                        <div class="analytic__content">
                            <div class="analytic__header">
                                ...
                                <div class="analytic__sec"><img src="@/assets/img/calendar_today.svg"
                                        style="width:1.25vw; margin-right:0.521vw" alt="">
                                    21.04.2022 - 21.05.2022</div>
                            </div>
                ...
                <div class="col">
                    <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                        <canvas id="chart-bars" class="chart-canvas chartjs-render-monitor" height="170"
                            style="display: block; height: 15.938vw; width: 45.417vw; box-sizing: border-box;"
                            width="495"></canvas>
                    </div>
                </div>
        ...
        const myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointRadius: 0,
                    backgroundColor: "#fff",
                    data: [400, 400, 800, 1000, 1200, 1200, 1200, 1250, 1280, 1200, 1000, 1200, 400],
                    maxBarThickness: 6,
                    color: "#fff",
                    borderColor: "#fff",
                },],
