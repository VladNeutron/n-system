              ...
              <div class="col">
                <div class="cash__left">
                  <div class="cash__left__blue">
                      ...
                      <div class="cash__blue__block">
                        <div class="cash__blue__content">
                          <div class="cash__blue__text">
                            <img src="@/assets/img/calculator.svg" style="width: 1.667vw; margin-right: 0.833vw"
                              alt="" />
                            Продажа
                          </div>
                        </div>
                    ...
                    <router-link :to="{ name: 'cash-register-return' }">
                      <div class="cash__blue__block">
                        <div class="cash__blue__content">
                          <div class="cash__blue__text">
                            <img src="@/assets/img/shopping_cart.svg" style="width: 1.667vw; margin-right: 0.833vw"
                              alt="" />
                            Возврат
                          </div>
                        </div>
                  ...
                  <div class="cash__left__green">
                    ...
                    <div class="cash__blue__block" data-bs-toggle="modal" data-bs-target="#sureModal">
                      <div class="cash__green__content">
                        <div class="cash__blue__text">
                          <img src="@/assets/img/lock_clock.svg" style="width: 1.667vw; margin-right: 0.833vw" alt="" />
                          Закрыть смену
                        </div>
                      </div>
                    </div>
                    <div class="cash__blue__block" @click="shiftStatus = 'open'">
                      <div class="cash__green__content">
                        <div class="cash__blue__text">
                          <img src="@/assets/img/update.svg" style="width: 1.667vw; margin-right: 0.833vw" alt="" />
                          Открыть смену
                        </div>
                      </div>
                    </div>
              ...
              <div class="col" style="margin-top: 1vw">
                <div class="shift__info">
                  <div class="shift__header">
                    <p class="shift__title">Информация о смене</p>
                    <p class="shift__status" :class="getClass(shiftStatus)">
                      {{ buttonText }}
                    </p>
                  </div>
                  <div class="shift__body">
                    <div class="shift__first__row">
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">№ Номер смены</label>
                        <input class="form-control first" type="text" placeholder="№ 9876543" id="example-text-input"
                          disabled />
                      </div>
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Торговая точка</label>
                        <input class="form-control second" type="text" placeholder="ТЦ “Mega”" id="example-text-input"
                          disabled />
                      </div>
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Выручка за день</label>
                        <input class="form-control text-right second" type="text" placeholder="345 000 ₸"
                          id="example-text-input" disabled />
                      </div>
                    </div>
                    <div class="shift__second__row">
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Время открытия смены</label>
                        <input class="form-control first" type="text" placeholder="09:59" id="example-text-input"
                          disabled />
                      </div>
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Чеков за сегодня</label>
                        <input class="form-control first" type="text" placeholder="323" id="example-text-input"
                          disabled />
                      </div>
                    </div>
                  </div>
                ...
                <div class="shift__info">
                  ...
                  <div class="shift__body2" style="display: flex; align-items: flex-end">
                    <div class="form-group" style="margin-right: 1.25vw">
                      <label for="exampleFormControlSelect1" class="form-control-label">Выбор кассы</label>
                      <div class="select2">
                        <select class="form-select first__s" id="exampleFormControlSelect1">
                          <option disabled selected>Выберите</option>
                          <option>Касса №1 Главная</option>
                          <option>Касса №1 Главная</option>
                          <option>Касса №1 Главная</option>
                        </select>
                      </div>
...
export default {
  ...
  methods: {
    getClass(stat) {
      if (stat === "open") {
        this.buttonText = "Открыта";
        return "open";
      }
      if (stat === "closed") {
        this.buttonText = "Закрыта";
        return "closed";
      }
    },
  },
...
.shift__status {
  ...
  color: #ffffff;
  margin: none;
  padding: 0.417vw 1.771vw 0.417vw 1.771vw;
}
...
.card__padding {
  padding: 1.604vw 4.479vw 1vw 3.125vw;
}
