  ...
  <main class="main-content border-radius-lg">
    ...
    <div class="company__content">
      <div class="company__header">
        <p class="company__main">Характеристики</p>
        <p class="company__sec">Настройка характеристики товаров</p>
      </div>
      <div class="row">
        <div class="col">
          <div class="character">
...
.modal__body {
  padding: 1.25vw 2.292vw 0 2.292vw;
}
.modal__label {
  font-weight: 600;
  font-size: 0.729vw;
...
.character__body::-webkit-scrollbar {
  background: #e2e8f0;
  border-radius: 0.78vw;
  width: 0.37vw;
}
.character__body::-webkit-scrollbar-thumb {
  border-radius: 0.78vw;
  background-color: #313860;
}
.character__body::-webkit-scrollbar-track {
