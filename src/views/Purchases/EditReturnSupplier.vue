                ...
                <div class="order__header-content">
                    <div class="order__header-main">
                        <div class="order__header-text">
                            <p class="order__header__main"> Возврат №2354657</p>
                        ...
                        <div class="drop__buttons">
                            <button class="btn comment">
                                <img src="@/assets/img/comment.svg" style="width: 1.042vw; margin-right: 0.417vw"
                                    alt="" />
                                Комментарии <span class="count">4</span>
                            </button>
                            <div class="dropdown">
                                <button class="btn action" type="button" id="dropdownMenuButton"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="@/assets/img/action.svg" style="width: 1.042vw; margin-right: 0.417vw"
                                        alt="" />
                                    Действия
                                </button>
                                ...
                                <div class="order__body__content">
                                    <div class="order__first__row">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label order__label">№
                                                Поступления</label>
                                            <input class="form-control" type="text" id="example-text-input"
                                                placeholder="№ 9876543" />
                                        </div>
                                        <div class="form-group">
                                            <label for="example-date-input" class="form-control-label order__label">Дата
                                                поступления</label>
                                            <input class="form-control" type="date" id="example-date-input" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1"
                                                class="order__label">Ответственный</label>
                                            <div class="select">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1"
                                                class="order__label">Контрагент</label>
                                            <div class="select">
                                                <img src="@/assets/img/arrow.svg" style="width: 0.833vw" alt="" />
                                                <select class="form-control" id="exampleFormControlSelect1">
                                                    <option>Выберите</option>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1"
                                                class="order__label">Поступление</label>
                                            <div class="select">
                                                <img src="@/assets/img/arrow.svg" style="width: 0.833vw" alt="" />
                                                <select class="form-control" id="exampleFormControlSelect1">
                                                    <option>Выберите</option>
                                    ...
                                    <div class="order__second__row">
                                        <div class="form-group">
                                            <label for="example-text-input"
                                                class="form-control-label order__label">Комментарий</label>
                        ...
                        <div class="barcodes">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control barcode__inp" placeholder="Введите штрихкод"
                                        id="search-barcode" type="text" />
                                    <span class="input-group-text py-0"><img src="@/assets/css/icons/barcode.svg"
                                            alt="" /></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-0">
                                <div class="input-group mt-1">
                                    <span class="input-group-text"><img src="@/assets/css/icons/searchIcon.svg"
                                            alt="" /></span>
                                    <input class="form-control search__inp" placeholder="Поиск..." id="search"
