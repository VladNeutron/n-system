  ...
  <main class="main-content border-radius-lg">
    ...
    <div class="card pt-4 pb-6 m-4">
      <div class="d-flex justify-content-between align-items-center mx-4 mb-4">
        <div>
          <button class="btn bg-gradient-dark mb-0" style="margin-right: 0.833vw" onclick="window.location.href = '/purchases/create-income'">
            <img src="@/assets/img/whtplus.svg" alt="" /> Новое поступление
          </button>
        </div>
